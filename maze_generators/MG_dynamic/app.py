...
@app.route("/")
def add_to_list():
    r = requests.put("http://sp22-cs240-adm.cs.illinois.edu:24000/addMG", json={"name": "Random Maze (Dynamic) [REAL]", "url": "http://172.22.152.32:24010", "author": "Matt Hamilton", "weight": 1})
